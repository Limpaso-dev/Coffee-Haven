import coffeeImage from "../../assets/images/Herosection.jpeg";
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-gray-600 ml-9">
                We source high-quality beans and roast them in small batches to
                ensure maximum freshness, aroma, and rich, natural flavor.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 ml-9">
                Every cup is brewed with precision, balancing temperature,
                grind, and extraction to give you a consistently smooth and
                satisfying taste.
              </p>
            </div>
          </div>
